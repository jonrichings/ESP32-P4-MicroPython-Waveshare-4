...
if(LV_MICROPYTHON AND NOT MICROPY_REGISTERING_CORE)
  idf_component_register(
    ...
    REQUIRES
    main)
elseif(LV_MICROPYTHON)
  # When being included as part of MicroPython core component,
  # we don't call idf_component_register but we do want the sources.
  # These are gathered via usermod_gather_sources.
else()
