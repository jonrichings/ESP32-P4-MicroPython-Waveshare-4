...
#define MICROPY_HW_BOARD_NAME "ELECROW_P4_ADVANCED"
#endif
...
// I2C 0 (Internal - STC8 PMU, Audio Codec)
...
#define MICROPY_PY_NETWORK_HOSTNAME_DEFAULT "Elecrow-P4"
...
#define MICROPY_BOARD_STARTUP elecrow_startup
void elecrow_deinit(void);
#define MICROPY_BOARD_DEINIT elecrow_deinit
