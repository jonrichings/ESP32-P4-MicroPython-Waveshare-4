...
#else
#pragma message "DEBUG: CONFIG_SLAVE_IDF_TARGET_ESP32C6 is NOT seen as true"
#ifndef CONFIG_SLAVE_IDF_TARGET_ESP32C6
#pragma message "DEBUG: CONFIG_SLAVE_IDF_TARGET_ESP32C6 is NOT DEFINED AT ALL"
#else
#pragma message "DEBUG: CONFIG_SLAVE_IDF_TARGET_ESP32C6 is DEFINED but evaluates to false"
#endif
