 ...
 **************************************************************************************************/
#define BSP_LCD_PIXEL_CLOCK_MHZ (51)

#if (BSP_CONFIG_NO_GRAPHIC_LIB == 0)

#define BSP_LCD_DRAW_BUFF_SIZE                                                 \
  (BSP_LCD_H_RES * 100) // Frame buffer size in pixels
